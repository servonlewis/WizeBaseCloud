					...
					<Grid container>
						<Grid item lg={6} md={6} sm={12} xs={12}>
							<div className="footer1__about">
								<h4>About Us</h4>
								<p>
									Wizebase is a Family ran company who are committed to providing you with the tools
									you need to get start just like us!.
								</p>
							...
							<div className="footer1__contact">
								...
								<div className="px-16 mt-32">
									...
									<div className="pl-16">
										...
										<p className="m-0 p-0">Brooklyn, Ny</p>
									</div>
								</div>
							</div>
						</Grid>
